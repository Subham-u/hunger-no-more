            ...
            <div className="lg:px-20 md:px-6 px-4 py-12">
                ...
                <div class="card shadow-md transition duration-300 hover:shadow-lg p-2 px-4 bg-white rounded-lg w-1/2">
                    ...
                    <div className="grid grid-cols-2 gap-1 mb-3">
                        <img src="/cleaning/cleaning1.jpeg" alt="" className="w-full h-auto rounded" />
                        <img src="/cleaning/cleaning2.jpeg" alt="" className="w-full h-auto rounded" />
                        <img src="/cleaning/cleaning3.jpeg" alt="" className="w-full h-auto rounded" />
                        <img src="/cleaning/cleaning4.jpeg" alt="" className="w-full h-auto rounded" />
                    </div>
                        <div class="container">
                ...
                {/* <div class="card shadow-md transition duration-300 hover:shadow-lg p-2 px-4 bg-white rounded-lg w-80">
                <div className="grid grid-cols-2 gap-1">
                        ...
                        <div class="container">
                            ...
                            <p class="text-gray-700">Architect & Engineer</p>
                        </div>
                </div> */}
                </div>
            </div>
